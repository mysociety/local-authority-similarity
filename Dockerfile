...
FROM ghcr.io/mysociety/data_common:sha-3a43ffc
...
RUN mkdir /setup/src/local_authority_similarity \
    && touch /setup/src/local_authority_similarity/__init__.py \
    ...
    && echo "/workspaces/local_authority_similarity/src/" > /usr/local/lib/python3.10/site-packages/local_authority_similarity.pth \
    && echo "/workspaces/local_authority_similarity/src/data_common/src" > /usr/local/lib/python3.10/site-packages/data_common.pth
